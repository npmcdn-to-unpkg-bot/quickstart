...
export class ListService {
  ...
  // ******* moved functionality to the delete/delete.service.ts and services/delete_endpoint.php
  delete_row_API (drivername:string):Observable<Driver[]> {
    ...
    let delete_url = "http://" + location.host +
        "/app/services/delete_endpoint.php?drivername=" + drivername;
